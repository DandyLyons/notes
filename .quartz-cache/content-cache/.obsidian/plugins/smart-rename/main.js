  ...
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/FileSystem.cjs"(exports2, module2) {
    ...
    function checkExtension(app, pathOrFile, extension2) {
      ...
      if (typeof pathOrFile === "string") {
        ...
        return (0, import_Path2.extname)(pathOrFile).slice(1) === extension2;
      }
      return false;
    }
    ...
    function getFile2(app, pathOrFile, shouldIncludeNonExisting, isCaseInsensitive) {
    ...
    function getResolvedPath(path) {
      return (0, import_obsidian3.normalizePath)((0, import_Path2.resolve)("/", path));
    }
  }
});
...
var require_Frontmatter = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/Frontmatter.cjs"(exports2, module2) {
    ...
    function parseFrontmatter(content3) {
      const frontmatterInfo = (0, import_obsidian3.getFrontMatterInfo)(content3);
...
var require_Vault = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/Vault.cjs"(exports2, module2) {
    ...
    function getNoteFilesSorted(app) {
      return app.vault.getAllLoadedFiles().filter((file) => (0, import_FileSystem2.isFile)(file) && (0, import_FileSystem2.isNote)(app, file)).sort((a, b) => a.path.localeCompare(b.path));
    }
    function getSafeRenamePath(app, oldPathOrFile, newPath) {
      const oldPath = (0, import_FileSystem2.getPath)(app, oldPathOrFile);
    ...
    async function isEmptyFolder(app, pathOrFolder) {
      const listedFiles = await listSafe(app, (0, import_FileSystem2.getPath)(app, pathOrFolder));
      return listedFiles.files.length === 0 && listedFiles.folders.length === 0;
    }
    async function listSafe(app, pathOrFolder) {
      const path = (0, import_FileSystem2.getPath)(app, pathOrFolder);
      ...
      await (0, import_Async2.retryWithTimeout)(async () => {
        ...
        function handleMissingFile() {
          if (fullOptions.shouldFailOnMissingFile) {
            const path = (0, import_FileSystem2.getPath)(app, pathOrFile);
    ...
    async function invokeFileActionSafe(app, pathOrFile, fileAction) {
      const path = (0, import_FileSystem2.getPath)(app, pathOrFile);
      const file = (0, import_FileSystem2.getFileOrNull)(app, path);
      ...
      try {
        ...
        const file2 = (0, import_FileSystem2.getFileOrNull)(app, path);
...
var require_FileManager = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/FileManager.cjs"(exports2, module2) {
    ...
    async function processFrontmatter2(app, pathOrFile, frontmatterFn, processOptions = {}) {
      const file = (0, import_FileSystem2.getFile)(app, pathOrFile);
      await (0, import_Vault2.process)(app, file, async (content3) => {
        const oldFrontmatter = (0, import_Frontmatter.parseFrontmatter)(content3);
        const newFrontmatter = (0, import_Frontmatter.parseFrontmatter)(content3);
        ...
        return (0, import_Frontmatter.setFrontmatter)(content3, newFrontmatter);
      }, processOptions);
    }
  }
});
  ...
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/FileChange.cjs"(exports2, module2) {
    ...
    async function applyFileChanges(app, pathOrFile, changesProvider, processOptions = {}) {
      await (0, import_Vault2.process)(app, pathOrFile, async (content3) => {
        ...
        const frontmatter = (0, import_FileSystem2.isCanvasFile)(app, pathOrFile) ? JSON.parse(content3) : (0, import_Frontmatter.parseFrontmatter)(content3);
          ...
          if (isContentChange(change)) {
            ...
            if (actualContent !== change.oldContent) {
              console.warn("Content mismatch", {
                ...
                path: (0, import_FileSystem2.getPath)(app, pathOrFile),
        ...
        if ((0, import_FileSystem2.isCanvasFile)(app, pathOrFile)) {
...
var require_MetadataCache = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/MetadataCache.cjs"(exports2, module2) {
    ...
    async function saveNote(app, pathOrFile) {
      if (!(0, import_FileSystem2.isMarkdownFile)(app, pathOrFile)) {
        return;
      }
      const path = (0, import_FileSystem2.getPath)(app, pathOrFile);
  ...
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/Link.cjs"(exports2, module2) {
    ...
    async function editBacklinks(app, pathOrFile, linkConverter, processOptions = {}) {
      ...
      for (const backlinkNotePath of backlinks.keys()) {
        ...
        await editLinks2(app, backlinkNotePath, (link2) => {
    ...
    async function editLinks2(app, pathOrFile, linkConverter, processOptions = {}) {
    ...
    function extractLinkFile2(app, link2, sourcePathOrFile) {
      ...
      return app.metadataCache.getFirstLinkpathDest(linkPath, (0, import_FileSystem2.getPath)(app, sourcePathOrFile));
    }
    function generateMarkdownLink2(options) {
      ...
      const targetFile = (0, import_FileSystem2.getFile)(app, options.targetPathOrFile, options.isNonExistingFileAllowed);
      return (0, import_MetadataCache2.tempRegisterFileAndRun)(app, targetFile, () => {
        const sourcePath = (0, import_FileSystem2.getPath)(app, options.sourcePathOrFile);
        const subpath = options.subpath ?? "";
        let alias = options.alias ?? "";
        const isEmbed = options.isEmbed ?? (options.originalLink ? testEmbed(options.originalLink) : void 0) ?? !(0, import_FileSystem2.isMarkdownFile)(app, targetFile);
        ...
        let linkText = targetFile.path === sourcePath && subpath ? subpath : shouldForceRelativePath ? (0, import_Path2.relative)((0, import_Path2.dirname)(sourcePath), isWikilink ? (0, import_FileSystem2.trimMarkdownExtension)(app, targetFile) : targetFile.path) + subpath : app.metadataCache.fileToLinktext(targetFile, sourcePath, isWikilink) + subpath;
        ...
        if (!isWikilink) {
          ...
          if (!alias && (!isEmbed || !options.isEmptyEmbedAliasAllowed)) {
            alias = !options.shouldIncludeAttachmentExtensionToEmbedAlias || (0, import_FileSystem2.isMarkdownFile)(app, targetFile) ? targetFile.basename : targetFile.name;
          }
    ...
    function shouldResetAlias(options) {
      ...
      const targetFile = (0, import_FileSystem2.getFile)(app, targetPathOrFile, true);
      const newSourcePath = (0, import_FileSystem2.getPath)(app, newSourcePathOrFile);
      const oldSourcePath = (0, import_FileSystem2.getPath)(app, oldSourcePathOrFile ?? newSourcePathOrFile);
      const newSourceDir = (0, import_Path2.dirname)(newSourcePath);
      const oldSourceDir = (0, import_Path2.dirname)(oldSourcePath);
      ...
      for (const pathOrFile of [targetFile.path, oldTargetPath]) {
        ...
        aliasesToReset.add((0, import_Path2.relative)(newSourceDir, path));
        aliasesToReset.add((0, import_Path2.relative)(oldSourceDir, path));
      }
    ...
    function splitSubpath(link2) {
      const parsed = (0, import_obsidian3.parseLinktext)((0, import_String2.normalize)(link2));
      return {
    ...
    function updateLink(options) {
      ...
      const targetFile = (0, import_FileSystem2.getFile)(app, newTargetPathOrFile, true);
      const oldTargetPath = (0, import_FileSystem2.getPath)(app, oldTargetPathOrFile ?? newTargetPathOrFile);
      const isWikilink = testWikilink(link2.original) && shouldForceMarkdownLinks !== true;
      const { subpath } = splitSubpath(link2.link);
      if ((0, import_FileSystem2.isCanvasFile)(app, newSourcePathOrFile)) {
      ...
      if (shouldUpdateFilenameAlias ?? true) {
        if (alias?.toLowerCase() === (0, import_Path2.basename)(oldTargetPath, (0, import_Path2.extname)(oldTargetPath)).toLowerCase()) {
          alias = targetFile.basename;
        } else if (alias?.toLowerCase() === (0, import_Path2.basename)(oldTargetPath).toLowerCase()) {
    ...
    async function updateLinksInFile(options) {
      ...
      if ((0, import_FileSystem2.isCanvasFile)(app, newSourcePathOrFile) && !app.internalPlugins.getEnabledPluginById("canvas")) {
        return;
      }
      await editLinks2(app, newSourcePathOrFile, (link2) => {
...
var SmartRenamePluginSettings = class extends import_PluginSettingsBase.PluginSettingsBase {
...
var SmartRenamePluginSettingsTab = class extends import_PluginSettingsTabBase.PluginSettingsTabBase {
  display() {
    ...
    if (this.plugin.settingsCopy.invalidCharacterAction === "Replace" /* Replace */) {
      new import_obsidian.Setting(this.containerEl).setName("Replacement character").setDesc("Character to replace invalid character with").addText((text4) => {
        text4.inputEl.maxLength = 1;
        text4.inputEl.required = true;
        (0, import_ValueComponent.extend)(text4).bind(this.plugin, "replacementCharacter", {
...
var SmartRenamePlugin = class extends import_PluginBase.PluginBase {
  ...
  async processBacklinks(oldPath, newPath, backlinks) {
    ...
    for (let backlinkNotePath of backlinks.keys()) {
      ...
      const linkJsons = new Set(links.map((link2) => (0, import_Object.toJson)(link2)));
      await (0, import_Link.editLinks)(this.app, backlinkNotePath, (link2) => {
        if ((0, import_Link.extractLinkFile)(this.app, link2, backlinkNotePath) !== newFile && !linkJsons.has((0, import_Object.toJson)(link2))) {
          return;
        }
        const alias = (link2.displayText ?? "").toLowerCase() === newTitle.toLowerCase() ? oldTitle : link2.displayText;
  ...
  async updateFirstHeader(newPath, titleToStore) {
    ...
    await (0, import_Vault.process)(this.app, newPath, async (content3) => {
      ...
      return (0, import_String.insertAt)(content3, `# ${titleToStore}`, firstHeading.position.start.offset, firstHeading.position.end.offset);
    });
  }
