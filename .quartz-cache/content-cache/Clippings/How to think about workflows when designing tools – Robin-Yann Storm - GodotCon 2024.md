...
## Description
When creating plugins, publicly available tools, or in-house one off fixes, it can be easy to shoot for only exactly what the tool is supposed to achieve. Ho...
