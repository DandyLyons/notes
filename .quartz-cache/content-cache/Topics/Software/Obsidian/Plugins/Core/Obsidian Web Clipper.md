...
| [Official site](https://obsidian.md/clipper)                                                       | [Official docs](https://help.obsidian.md/web-clipper) |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| [Official Roadmap](https://github.com/obsidianmd/obsidian-clipper?tab=readme-ov-file#roadmap) <br> |                                                       |
