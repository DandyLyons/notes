...
| ------------ | ------------------------------------------------------------------------------------------------------ |
| Docs         | [docs](https://mprojectscode.github.io/obsidian-meta-bind-plugin-docs)                                 |
| Obsidian URL | obsidian://show-plugin?id=obsidian-meta-bind-plugin                                                    |
| Examples     | [example vault](https://github.com/mProjectsCode/obsidian-meta-bind-plugin/tree/master/exampleVault)\| |
...
## Buttons
- [Buttons \| Meta Bind Docs](https://www.moritzjung.dev/obsidian-meta-bind-plugin-docs/guides/buttons/) 
- [Button Command Action \| Meta Bind Docs](https://www.moritzjung.dev/obsidian-meta-bind-plugin-docs/reference/buttonactions/command/) 
- [Button examples](https://github.com/mProjectsCode/obsidian-meta-bind-plugin/tree/master/exampleVault/Buttons) 