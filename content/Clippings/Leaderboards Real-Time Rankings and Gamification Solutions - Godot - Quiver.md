...
![](https://redis.io/wp-content/uploads/2020/07/leaderboard-example-a.svg?&auto=webp&quality=85,75&width=500)
...
Redis Enterprise is based on a [shared-nothing, symmetric architecture](https://redis.io/redis-enterprise/technology/redis-enterprise-cluster-architecture/) that lets dataset sizes grow linearly and seamlessly without requiring changes to the application code.
...
Once the Redis Node packages are installed into your web app project, you can access Redis functionality via a JavaScript API. (The official docs at [the node\_redis Github repository](https://github.com/NodeRedis/node_redis) can help you get started.)
...
![leaderboard-playerdata](https://redis.io/wp-content/uploads/2020/07/leaderboard-playerdata.svg?format=pjpg&auto=webp&quality=1&width=500)
...
`1) "screenName"   2) "Fred"   3) "lastLoggedIn"   4) "2019-07-30"`
...
![leaderboard-datachart](https://redis.io/wp-content/uploads/2020/07/leaderboard-datachart.svg?format=pjpg&auto=webp&quality=1&width=500)
...
Now you can easily implement a solution that pulls the data using Node and the node\_redis package so that you can keep the leaderboard fresh on your web app. This work is easy using the node\_redis package API, which allows you to pull back the Sorted Set by name (playerRank).
...
![Intro to Leaderboards](https://redis.io/wp-content/uploads/2022/07/intro-to-leaderboards-webinars-page.jpg?format=pjpg&auto=webp&quality=1&width=772)
